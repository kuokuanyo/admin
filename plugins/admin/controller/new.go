...
func (h *Handler) showNewForm(ctx *context.Context, alert template2.HTML, prefix, paramStr string, isNew bool) {
	...
	fmt.Println("test")
	fmt.Println(h.authSrv().AddToken())
	fmt.Println(infoUrl)
...
func (h *Handler) NewForm(ctx *context.Context) {
	...
	fmt.Println("param")
	fmt.Println(param)
	fmt.Println("param test")
	//fmt.Println(param.Value())
	fmt.Println("param.Prefix")
	fmt.Println(param.Prefix)
	fmt.Println("param.Param.GetRouteParamStr()")
	fmt.Println(param.Param.GetRouteParamStr())
	fmt.Println("param.Param")
	fmt.Println(param.Param)

	fmt.Println("param Panel")
	fmt.Println(param.Panel)
	...
	fmt.Println(param.Path)
	fmt.Println("param MultiForm")
	fmt.Println(param.MultiForm)
	fmt.Println("param PreviousPath")
	fmt.Println(param.PreviousPath)
	fmt.Println("param FromList")
	fmt.Println(param.FromList)
	fmt.Println("param Alert")
	fmt.Println(param.Alert)
